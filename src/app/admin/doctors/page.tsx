...
function Page() {
  ...
  const sortedData = [...filteredDoctors].sort((a : any, b : any) => {
    ...
    return sortOrder === "asc"
      ? valueA.en.localeCompare(valueB.en)
      : valueB.en.localeCompare(valueA.en);
  });
  ...
  return (
    <DashboardLayout title="Doctors" loading={!doctors}>
      ...
      {sortedData.length > 0 ? (
        renderTable("Doctors", sortedData)
      ) : (
